      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid md:grid-cols-2 gap-12 md:gap-16">
          <div>
            ...
            <div className="space-y-6">
              {[
                ...
                <div key={i} className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-lg bg-canvas border border-line flex items-center justify-center text-xl">
                    {c.icon}
                  </div>
                  <div>
            ...
            <div className="mt-10">
              <h4 className="text-xs text-soft uppercase tracking-wide mb-4">Follow Us</h4>
          ...
          <div>
            <form onSubmit={submit} className="border border-line rounded-xl p-6 md:p-8 bg-canvas/50">
              ...
              {submitted ? (
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <label className="text-xs text-soft uppercase tracking-wide mb-2 block">Subject</label>
                  ...
                  <div>
                    <label className="text-xs text-soft uppercase tracking-wide mb-2 block">Message</label>
